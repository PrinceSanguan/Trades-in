...
const areas = ['Area One', 'Area Two', 'Area Three', 'Area Four', 'Area Five', 'Area Six'];
...
export default function ServiceAreasSection({ phone, phoneDisplay }: ServiceAreasSectionProps) {
        ...
        <section className={styles.section}>
            <div className={styles.container}>
                <div className={styles.header}>
                    ...
                    <p className={styles.subtitle}>Covering Your Local Area</p>
                    <p className={styles.description}>
                        We provide professional services across the region. Contact us to check if we cover your area.
                    </p>
                </div>
                ...
                <div className={styles.grid}>
                    {areas.map((area) => (
                        <div key={area} className={styles.areaCard}>
                            ...
                            <p className={styles.areaName}>{area}</p>
                        </div>
                    ))}
                </div>

                <div className={styles.callout}>
                    <p className={styles.calloutText}>Check area coverage</p>
                    {phone && (
                        <p className={styles.calloutPhone}>
                            {phoneDisplay || phone}
                        </p>
                    )}
                </div>
